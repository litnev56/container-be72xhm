...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-be72xhm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-be72xhm.containers.anotherwebservice.com/
...
```
git clone git@github.com:litnev56/container-be72xhm.git
cd container-be72xhm
```
...
```
docker attach container-be72xhm
```
